...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="${pageContext.request.contextPath}/noticebillAction_addnoticebill.action" method="post">
					...
					<script  type="text/javascript">
                        $(function () {
                            ...
                            $("input[name=telephone]").blur(function () {
                                ...
                                //发送ajax请求，远程调用webservice服务，访问crm。回显数据
                                var  url='${pageContext.request.contextPath}/noticebillAction_findListByTelephone.action';
                                $.post(url,{"telephone":telephone},function (data) {
                                    if(data!=null){
                                        //如果没有此客户，就将文本框的值清空，有就将数据回显出来
                                        ...
                                        $.messager.alert("提示信息","客户信息为空","warning");
									}
                                });
                            });
                        });
