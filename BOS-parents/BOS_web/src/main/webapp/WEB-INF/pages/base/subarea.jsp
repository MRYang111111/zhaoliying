...
<script type="text/javascript">
    ...
    function doShowSubArea(){
       alert("查询分区数据");
        $('#showSubArea').window("open");
        url='${pageContext.request.contextPath}/subAreaAction_showSubAreaGroupByProvince.action';
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<%--查询分区的数据图--%>
	<!-- 查询分区 -->
	<div class="easyui-window" title="分区数据显示图" id="showSubArea" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div id="test"></div>
		</div>
